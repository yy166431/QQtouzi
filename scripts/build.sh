...
xcrun --sdk iphoneos clang -isysroot "$IOS_SDK" -target arm64-apple-ios15.0 \
  ...
  -Wl,-compatibility_version,1.0 -Wl,-current_version,0.4.0 \
  Sources/QDCore.m Sources/QDWire.m Sources/QQDice.m -o build/QQtouzi.dylib
